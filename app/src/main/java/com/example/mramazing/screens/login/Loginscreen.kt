package com.example.mramazing.screens.login
...
fun LoginScreen(navController: NavHostController) {
    ...
    Column(modifier = Modifier
        ...
        Button(onClick = {
            val mylogin = AppViewModel(navController, context)
            mylogin.login(email.text.trim(),phonenumber.text.trim())
        ...
        Image(painter = painterResource(id = R.drawable.logo5),
